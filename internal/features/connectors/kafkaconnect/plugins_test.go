	...
	tests := []struct {
	...
	}{
		{
			...
			want: domain.ConnectorPluginSchema{
				Fields: []domain.ConnectorPluginField{
					{
						Name:        "database.hostname",
						Label:       new("Database Hostname"),
						Description: new("IP address or hostname of the PostgreSQL database server."),
						Type:        "STRING",
						Importance:  "HIGH",
						Required:    true,
					},
		...
		},
		{
			...
			want: domain.ConnectorPluginSchema{Fields: []domain.ConnectorPluginField{{
				Name:        "insert.field",
				Label:       new("Insert field"),
				Description: new("Field to insert"),
				Type:        "STRING",
				Importance:  "MEDIUM",
				Required:    false,
				Default:     new("value"),
